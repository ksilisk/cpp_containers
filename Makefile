...
SOURCES_CC := $(wildcard $(addsuffix /*.cc,$(SOURCE_PATH)))
...
format:
	@clang-format --style=Google -i $(SOURCES) $(SOURCES_CC) $(SOURCE_PATH)/tests/*.cpp

check-format:
	@clang-format --style=Google -n $(SOURCES) $(SOURCES_CC) $(SOURCE_PATH)/tests/*.cpp
